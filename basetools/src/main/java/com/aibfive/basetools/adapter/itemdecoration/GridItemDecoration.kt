...
class GridItemDecoration : RecyclerView.ItemDecoration {
    ...
    constructor(orientation : Int, dividerWidth : Int, dividerHeight : Int, dividerColor : Int, includeEdge : Boolean){
        this.orientation = orientation
     ...
     * spanCount--列数、行数
     */
    fun isLastRight(position : Int, count : Int, spanCount : Int) : Boolean {
        when(orientation){
            ORIENTATION_VERTICAL->{//垂直方向
